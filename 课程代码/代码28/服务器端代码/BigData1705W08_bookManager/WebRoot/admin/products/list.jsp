...
<%--删除一本书 
confirm:有两个返回值true,false   true代表 确定
--%>
<script type="text/javascript">
	function delBook(id,name){
		if(confirm("你确定要删除"+name+"这本书吗?")){
			location.href="${pageContext.request.contextPath}/DeleteBookServlet?id="+id;
		}
	}
</script>
<%--全选/全不选的设置:通过复选框控制子复选框的状态 --%>
<script type="text/javascript">
	function checkAll(){
	    //得到全选/全不选标签
		var checkbox = document.getElementById("ckAll");
		//获取全选/全不选标签的状态值
		var value = checkbox.checked;
		//获取所有的子标签,让他们的状态与全选/全不选标签的状态保持一致
		var subcks = document.getElementsByName("subck");
...
<%--删除多行 设置
?name=bingbing&hobby=java&hobby=php&hobby=html&age=33
 --%>
<script type="text/javascript">
	function delBooks(){
		//获取所有的复选框子标签
				...
				<tr>
					<td class="ta_01" align="right">
					    <button type="button" id="add" name="add" value="批量删除"
							class="button_add" onclick="delBooks()">批量删除
						</button>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="24%">全选/全不选<input type="checkbox"  id="ckAll"   name="ckAll"  onclick="checkAll()" /></td>
							...
							<c:forEach  items="${books }"  var="book">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><input type="checkbox"  id="subck"   name="subck" value="${book.id }" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="23%">${book.id }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="javascript:delBook('${book.id }','${book.name }')">
											<img
